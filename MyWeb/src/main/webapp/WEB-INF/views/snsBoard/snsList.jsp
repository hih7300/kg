...
<body>
				...
				<div class="col-xs-12 col-sm-8 section-inner">
					...
					<!-- 
						...
						<div class="image-inner">
							...
							<img src="view?fileLoca=20191211&fileName=88f7ba4ff6014e9c8cfdc73317fae383.jpg">
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function regist() {
				var user_id = '${sessionScope.user_id}'; //세션 값
				// 자바스크립트의 파일확장자 체크
				var file = $("#file").val();
				...
				$.ajax({
					...
					contentType: false, // ajax방식에서는 반드시 false로 처리하면 "multipart/form-data"로 선언됨
			...
			function getList(reset) {
				...
				// 3. 단 화면에 띄워야 하는 이미지영역에는 src안에 view?값&값 호출하는 코드 작성
